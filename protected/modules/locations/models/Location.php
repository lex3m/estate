...
/**
 * This is the model class for table "{{apartment_location}}".
 *
 * The followings are the available columns in table '{{apartment_location}}':
 * @property integer $id
 * @property string $name
 *
 * The followings are the available model relations:
 * @property ApartmentSublocation[] $apartmentSublocations
 */
class Location extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'apartmentSublocations' => array(self::HAS_MANY, 'ApartmentSublocation', 'location_id'),
		);
	}
